...
const DICTIONARY: Record<ReviewLocale, Record<string, string>> = {
  en: {
    ...
    consentLabel: 'I consent to publishing my review on Jordan Story Travel & Tourism official website.',
    ...
    exploreCta: 'Explore Jordan Story Travel & Tourism',
  ...
  de: {
    ...
    consentLabel: 'Ich stimme der Veröffentlichung meiner Bewertung auf der offiziellen Website von Jordan Story Travel & Tourism zu.',
  ...
  fr: {
    ...
    consentLabel: 'J\'autorise la publication de mon avis sur le site officiel de Jordan Story Travel & Tourism.',
  ...
  it: {
    ...
    consentLabel: 'Acconsento alla pubblicazione della mia recensione sul sito ufficiale di Jordan Story Travel & Tourism.',
...
export const ReviewFormClient: React.FC<{ token: string }> = ({ token }) => {
