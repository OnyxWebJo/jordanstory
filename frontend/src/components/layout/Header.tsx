  ...
  return (
    <>
      <header 
        ...
        className="fixed top-0 left-0 right-0 py-3 sm:py-4 px-3 sm:px-8 transition-all duration-300"
      >
        <div 
        ...
        >
          ...
          {/* Right Action Group: Currency Switcher, Language Switcher & Book Now (Desktop) */}
          ...
          {/* Mobile Quick Action Buttons (Always Interactive) */}
      ...
      {/* Mobile Glass Drawer Overlay Navigation */}
      {isMobileMenuOpen && (
        <div 
          className="md:hidden fixed inset-0 z-[99990] flex flex-col justify-start"
          style={{ touchAction: 'pan-y' }}
        >
          {/* Backdrop with Safe Target Checking */}
          <div 
            className="fixed inset-0 bg-black/85 backdrop-blur-xl animate-fade-in"
            onClick={(e) => {
          ...
          <div 
            ...
            className="relative z-10 mx-3 mt-20 max-h-[82vh] overflow-y-auto p-5 rounded-3xl bg-[#1A1615] border border-white/20 shadow-2xl text-[#F7F4EE] space-y-4 animate-fade-in"
          >
            {/* Drawer Header Badge */}
            <div className="flex items-center justify-between pb-3 border-b border-white/10">
              ...
              <button
                type="button"
                onClick={() => setIsMobileMenuOpen(false)}
                className="p-2 rounded-full bg-white/10 hover:bg-white/20 text-[#C69C6D] transition-colors cursor-pointer"
