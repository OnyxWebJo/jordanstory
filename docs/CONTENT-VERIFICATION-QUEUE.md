...
|---|---|---|---|---|---|
| VER-01 | Petra Ticket Fee | 50 JOD (Free with Jordan Pass) | `01-Existing-Website-Data-Audit.md` | VERIFIED | Included in tour inclusion notices |
| VER-02 | Visa Assistance | Free Entry Visa Assistance | `31-Live-Tour-Inventory.csv` | VERIFIED | Included in all private tour packages |
| VER-03 | Chauffeur Transport | Private AC vehicle with English-speaking driver | `26-Booking-API-PHP-Spec.md` | VERIFIED | Included in all private tour packages |
